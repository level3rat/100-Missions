...
function refresh(){
  ...
  peasantPercentReds = Math.round((peasantRed / peasantVault)*100) + '%';
  peasantPercentDeeds = Math.round((peasantDeed / peasantVault)*100) + '%';
  commonerPercentReds = Math.round((commonerRed / commonerVault)*100) + '%';
  commonerPercentDeeds = Math.round((commonerDeed / commonerVault)*100) + '%';
  merchantPercentReds = Math.round((merchantRed / merchantVault)*100) + '%';
  merchantPercentDeeds = Math.round((merchantDeed / merchantVault)*100) + '%';
  soldierPercentReds = Math.round((soldierRed / soldierVault)*100) + '%';
  soldierPercentDeeds = Math.round((soldierDeed / soldierVault)*100) + '%';
  generalPercentReds = Math.round((generalRed / generalVault)*100) + '%';
  generalPercentDeeds = Math.round((generalDeed / generalVault)*100) + '%';
  emperorPercentReds = Math.round((emperorRed / emperorVault)*100) + '%';
  emperorPercentDeeds = Math.round((emperorDeed / emperorVault)*100) + '%';
